...
[Wikidata (Q15584858)](https://www.wikidata.org/wiki/Q15584858) · [Scholia](https://scholia.toolforge.org/taxon/Q15584858) · [GBIF](https://www.gbif.org/species/search?q=Eleocharis%20flavescens)

Read about this species on [Portuguese Wikipedia](https://pt.wikipedia.org/wiki/Eleocharis_flavescens).

Also available in: [English](https://en.wikipedia.org/wiki/Eleocharis_flavescens) · [Swedish](https://sv.wikipedia.org/wiki/Eleocharis_flavescens) · [Vietnamese](https://vi.wikipedia.org/wiki/Eleocharis_flavescens)

## Original description

*Eleocharis flavescens* was first described by **(Poir.) Urb.** in:

> Symb. Antill. 4: 116 (1903)

This species was originally described as *Scirpus flavescens* Poir. in J.B.A.M.de Lamarck, Encycl. 6: 756 (1805), and was later reclassified to its current name.

[View on GBIF](https://www.gbif.org/species/2717421)

## Taxonomic history

| Year | Event | Name | Reference |
|------|-------|------|-----------|
| 1805 | First described | *Scirpus flavescens Poir.* | J.B.A.M.de Lamarck, Encycl. 6: 756 (1805) |
| 1903 | Reclassified | *Eleocharis flavescens (Poir.) Urb.* | Symb. Antill. 4: 116 (1903) |
| — | Synonym deprecated | *Scirpus flavescens Poir., Encycl.* | [Plazi treatment](https://treatment.plazi.org/id/03F9C92C7E22FFD75CDEFDCD32258C37) |

## Global distribution

Map shows **300** georeferenced GBIF records (out of 1748 total) for *Eleocharis flavescens* worldwide. Click markers for details.

```{raw} html
<iframe src="../maps/Eleocharis_flavescens.html" width="100%" height="500px" frameborder="0" scrolling="no" style="border-radius:8px; margin-bottom:1rem;"></iframe>
```
...
- [Silva, Caio Lima Braga da; Nunes, Clebiana de Sá; Schneider, Layla Jamylle Costa; Silva, Juliene de Fátima Maciel da; Alves, Karina de Nazaré Lima; Conde, Maíra Luciana Guimarães; Fernandes-Junior, Aluisio José; Gil, André dos Santos Bragança — *Cyperaceae nos campos de natureza de Cametá, Pará, Amazônia, Brasil*](https://treatment.plazi.org/id/03F9C92C7E22FFD75CDEFDCD32258C37)
...
![Figura 5. A-L. Vista lateral das núculas: A. Eleocharis angustispicula, com cerdas perigoniais evidentes (C. L. Braga-Si...](https://zenodo.org/record/10627106/files/figure.png)
...
![Eleocharis flavescens — University of Florida](https://cdn.floridamuseum.ufl.edu/Herbarium/8fc39afb-b53b-4e89-8df5-96ab519283a5)
