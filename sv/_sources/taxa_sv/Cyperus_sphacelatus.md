...
[Wikidata (Q15535602)](https://www.wikidata.org/wiki/Q15535602) · [Scholia](https://scholia.toolforge.org/taxon/Q15535602) · [GBIF](https://www.gbif.org/species/search?q=Cyperus%20sphacelatus)

Read about this species on [Swedish Wikipedia](https://sv.wikipedia.org/wiki/Cyperus_sphacelatus).

Also available in: [English](https://en.wikipedia.org/wiki/Cyperus_sphacelatus) · [Indonesian](https://id.wikipedia.org/wiki/Cyperus_sphacelatus) · [Turkish](https://tr.wikipedia.org/wiki/Cyperus_sphacelatus) · [Vietnamese](https://vi.wikipedia.org/wiki/Cyperus_sphacelatus)

## Original description

*Cyperus sphacelatus* was first described by **Rottb.** in:

> Descr. Icon. Rar. Pl.: 26 (1773)

[View on GBIF](https://www.gbif.org/species/2715182)

## Global distribution

Map shows **300** georeferenced GBIF records (out of 1953 total) for *Cyperus sphacelatus* worldwide. Click markers for details.

```{raw} html
<iframe src="../maps/Cyperus_sphacelatus.html" width="100%" height="500px" frameborder="0" scrolling="no" style="border-radius:8px; margin-bottom:1rem;"></iframe>
```
...
- [Oliveira, Adriana; Bove, Claudia — *Checklist of aquatic and marshy Monocotyledons from the Araguaia River basin, Brazilian Cerrado*](https://treatment.plazi.org/id/36202F6DC107022EFC83CE17910DA503)

- [Oliveira, Adriana; Bove, Claudia — *Checklist of aquatic and marshy Monocotyledons from the Araguaia River basin, Brazilian Cerrado*](https://treatment.plazi.org/id/76FF04E0C8C31C648063779463CAFBAA)

- [Silva, Caio Lima Braga da; Nunes, Clebiana de Sá; Schneider, Layla Jamylle Costa; Silva, Juliene de Fátima Maciel da; Alves, Karina de Nazaré Lima; Conde, Maíra Luciana Guimarães; Fernandes-Junior, Aluisio José; Gil, André dos Santos Bragança — *Cyperaceae nos campos de natureza de Cametá, Pará, Amazônia, Brasil*](https://treatment.plazi.org/id/03F9C92C7E3EFFCB5F5DFE8F32C88BF6)

[View all treatments for *Cyperus sphacelatus* on Synospecies](https://synospecies.plazi.org/#Cyperus%20sphacelatus)
...
![Figura 4. A-M. Vista lateral das núculas: A. Bulbostylis conifera (A. Gil et al. 798 - MG); B. B. junciformis (C. L. Bra...](https://zenodo.org/record/10627104/files/figure.png)
...
![Cyperus sphacelatus — nan](http://n2t.net/ark:/65665/m32497bce4-176b-43d3-8427-e7d06fe3b913)

**Observation:** [https://www.gbif.org/occurrence/1321055822](https://www.gbif.org/occurrence/1321055822)  
**License:** [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)

![Cyperus sphacelatus — nan](http://n2t.net/ark:/65665/m3e83ead2f-aab3-4241-9551-ee02b8ed0995)
